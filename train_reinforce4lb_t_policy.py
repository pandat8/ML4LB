...
from utilities import instancetypes, instancesizes, incumbent_modes, t_reward_types, lbconstraint_mode_for
import torch
import random
import argparse
...
parser.add_argument('--instance_type', type=int, default=0,
                    help='training dataset, index into utilities.instancetypes '
