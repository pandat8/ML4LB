...
for i in range(2, 3):
    ...
    for j in range(1, 2):
        ...
        regression_init_k.test_lp(t_limit=samples_time_limit, instance_size=instance_size)
        ...
        # regression_init_k.evaluate_localbranching(test_instance_size='-small',train_instance_size='-small', total_time_limit=total_time_limit, node_time_limit=node_time_limit, reset_k_at_2nditeration=reset_k_at_2nditeration)
