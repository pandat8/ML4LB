...
class RlLocalbranch(MlLocalbranch):
    ...
    def primal_gap_integral_hybrid_03(self, test_instance_size, total_time_limit=60, node_time_limit=30):
        ...
        if self.incumbent_mode == 'firstsol':
            ...
            directory_lb_test_hybrid_2 = directory_2 + 'evaluation-reinforce4lb-from-' + 'rootsol' + '-t_node' + str(
                node_time_limit) + 's' + '-t_total' + str(
                total_time_limit) + 's' + test_instance_size + '/rlactive_t_node_baseline-rlpolicy-treward2/seed' + str(103) + '/' # -rlpolicy/seed' + str(self.seed) + '/',  /rlactive_t_node_baseline/seed'+ str(self.seed) + '/'
        elif self.incumbent_mode == 'rootsol':
            directory_2 = './result/generated_instances/' + self.instance_type + '/' + test_instance_size + '/' + self.lbconstraint_mode + '/' + 'firstsol' + '/' + 'rl/reinforce/test/old_models/'
            directory_lb_test_hybrid_2 = directory_2 + 'evaluation-reinforce4lb-from-' + 'firstsol' + '-t_node' + str(
                node_time_limit) + 's' + '-t_total' + str(
                total_time_limit) + 's' + test_instance_size + '/rlactive_t_node_baseline-rlpolicy-treward2/seed' + str(103) + '/' # , /rlactive_t_node_baseline/seed'+ str(self.seed) + '/'
        ...
        # fig.suptitle("Scaled primal gap", y=0.97, fontsize=13)
        # fig.tight_layout()
        plt.savefig('./result/plots/'  + 'plot_primalgap_' + self.instance_type  + '_' + str(test_instance_size) + '_' + self.incumbent_mode + '_hybrid_rlpolicy-tk_enable-tbaseline_t2_seed103.png') # _hybrid.png, _hybrid_t_node_baseline.png
        plt.show()
        plt.clf()
        ...
        plt.savefig('./result/plots/' + 'plot_primalintegral_' + self.instance_type + '_' + str(
            test_instance_size) + '_' + self.incumbent_mode + '_hybrid_rlpolicy-tk_enable-tbaseline_t2_seed103.png') # _rlpolicy-tk_enable-tbaseline' + ', _hybrid_t_node_baseline.png
        plt.show()
        plt.clf()
