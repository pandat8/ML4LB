...
for lr in lr_list:
    for r in range(0, 2):
        ...
        for i in range(0, 1):
            ...
            plt.savefig('./result/plots/rl_reinforce_train_t_policy' + instance_type + '_' + train_instance_size +  '_' + incumbent_mode + '_' + t_reward_type +'total_timelimit' + total_time_limit + 's' + '_lr ' + str(lr) + '.png')
            plt.show()
