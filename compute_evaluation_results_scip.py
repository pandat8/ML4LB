...
for j in range(1, 2):
    ...
    for k in range(0, 1):
        ...
        result_directory_2_original_cpu = evaluation_directory + 'lb-from-' + incumbent_mode + '-t_total' + str(
            total_time_limit) + 's' + '-t_node' + str(
            node_time_limit) + 's' + instance_size + '_lb_k0_regression_rl_beforenode_freq_0' + '/seed' + str(
            seed) + '/'
        ...
        #     seed) + '/'
        result_directory_4_original_cpu = evaluation_directory + 'lb-from-' + incumbent_mode + '-t_total' + str(
            total_time_limit) + 's' + '-t_node' + str(
        ...
        print(result_directory_2_original_cpu)
        print(result_directory_2_gpu)
        print(result_directory_4_original_cpu)
        ...
        if not ((dataset_id == 3 and k == 1) or (dataset_id == 4 and k == 1)):
            run_localbranch.primal_integral_scip_comparison(
                ...
                result_directory_2=result_directory_2_original_cpu,
                result_directory_3=result_directory_2_gpu,
                result_directory_4=result_directory_4_original_cpu
                )
