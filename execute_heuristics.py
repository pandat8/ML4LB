...
class ExecuteHeuristic:
    ...
    def __init__(self, instance_directory, solution_directory, result_directory, no_improve_iteration_limit=20, enable_solve_master_problem=True, seed=100, enable_gpu=False):
        ...
        self.enable_solve_master_problem = enable_solve_master_problem
    ...
    def execute_heuristic_per_instance(self, MIP_model, incumbent, node_time_limit, total_time_limit):
        ...
        MIP_model.setPresolve(pyscipopt.SCIP_PARAMSETTING.FAST)
        MIP_model.optimize()
        status = MIP_model.getStatus()
