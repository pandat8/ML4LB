...
class ExecuteHeuristic:
    ...
    def primal_integral_multicall_03(self, seed_mcts=100, instance_type = 'miplib_39binary', instance_size = '-small', incumbent_mode = 'root', total_time_limit=60, node_time_limit=30, result_directory_1=None, result_directory_2=None, result_directory_3=None, result_directory_4=None, result_directory_5=None, result_directory_6=None, result_directory_7=None, result_directory_8=None, result_directory_9=None):
        ...
        primal_int_base_ave_mul = primal_int_baselines_mul.sum() / len(primal_int_baselines_mul)
        primal_int_lns_lblp_ave_mul = primal_int_lns_lblp_list_mul.sum() / len(primal_int_lns_lblp_list_mul)
        primal_int_lns_random_ave_mul = primal_int_lns_random_list_mul.sum() / len(primal_int_lns_random_list_mul)
        primal_int_lns_lblpmcts_ave_mul = primal_int_lns_lblpmcts_list_mul.sum() / len(primal_int_lns_lblpmcts_list_mul)
        ...
        primal_gap_final_baseline_ave_mul = primal_gap_final_baselines_mul.sum() / len(primal_gap_final_baselines_mul)
        primal_gap_final_lns_lblp_ave_mul = primal_gap_final_lns_lblp_list_mul.sum() / len(primal_gap_final_lns_lblp_list_mul)
        primal_gap_final_lns_random_ave_mul = primal_gap_final_lns_random_list_mul.sum() / len(primal_gap_final_lns_random_list_mul)
        primal_gap_final_lns_lblpmcts_ave_mul = primal_gap_final_lns_lblpmcts_list_mul.sum() / len(
            primal_gap_final_lns_lblpmcts_list_mul)
        ...
        for n, stepline_baseline in enumerate(steplines_baseline_mul):
            ...
            if n == 0:
                ...
                primalgaps_baseline = np.vstack((primalgaps_baseline, primal_gap))
        primalgap_baseline_ave_mul = np.average(primalgaps_baseline, axis=0)
        ...
        for n, stepline_lns_lblp in enumerate(steplines_lns_lblp_list_mul):
            ...
            if n == 0:
                ...
                primalgaps_lns_lblp = np.vstack((primalgaps_lns_lblp, primal_gap))
        primalgap_lns_lblp_ave_mul = np.average(primalgaps_lns_lblp, axis=0)
        ...
        for n, stepline_lns_lblp in enumerate(steplines_lns_random_list_mul):
            ...
            if n == 0:
                ...
                primalgaps_lns_random = np.vstack((primalgaps_lns_random, primal_gap))
        primalgap_lns_random_ave_mul = np.average(primalgaps_lns_random, axis=0)
        ...
        for n, stepline_lns_lblpmcts in enumerate(steplines_lns_lblpmcts_list_mul):
            ...
            if n == 0:
                ...
                primalgaps_lns_lblpmcts = np.vstack((primalgaps_lns_lblpmcts, primal_gap))
        primalgap_lns_lblpmcts_ave_mul = np.average(primalgaps_lns_lblpmcts, axis=0)
        #
        # primalgaps_reinforce = None
        # for n, stepline_reinforce in enumerate(steplines_reinforce):
        #     primal_gap = stepline_reinforce(t)
        ...
        for n, pi_stepline_baseline in enumerate(pi_steplines_baseline_mul):
            ...
            if n == 0:
                ...
                pi_stack_baseline = np.vstack((pi_stack_baseline, pi_samples))
        pi_baseline_ave_mul = np.average(pi_stack_baseline, axis=0)
        ...
        for n, pi_stepline_lns_lblp in enumerate(pi_steplines_lns_lblp_list_mul):
            ...
            if n == 0:
                ...
                pi_stack_lns_lblp = np.vstack((pi_stack_lns_lblp, pi_samles))
        pi_lns_lblp_ave_mul = np.average(pi_stack_lns_lblp, axis=0)
        ...
        for n, pi_stepline_lns_lblp in enumerate(pi_steplines_lns_random_list_mul):
            ...
            if n == 0:
                ...
                pi_stack_lns_random = np.vstack((pi_stack_lns_random, pi_samples))
        pi_lns_random_ave_mul = np.average(pi_stack_lns_random, axis=0)
        ...
        for n, pi_stepline_lns_lblpmcts in enumerate(pi_steplines_lns_lblpmcts_list_mul):
            ...
            if n == 0:
                ...
                pi_stack_lns_lblpmcts = np.vstack((pi_stack_lns_lblpmcts, pi_samples))
        pi_lns_lblpmcts_ave_mul = np.average(pi_stack_lns_lblpmcts, axis=0)
        #
